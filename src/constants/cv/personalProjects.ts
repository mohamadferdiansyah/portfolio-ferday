...
export const SpotifyClone = {
  name: "VILLAPUNCAK123_NAME",
  artist: "VILLAPUNCAK123_ARTIST",
  length: "VILLAPUNCAK123_LENGTH",
  description: "VILLAPUNCAK123_DESCRIPTION",
  type: ProjectTypesEnum.WEB,
  imageUrl: getProjectPath("villapuncak123/logo.png"),
  link: "",
  github: "https://github.com/mohamadferdiansyah",
  skills: [tags.Laravel, tags.Php, tags.Tailwind, tags.Mysql],
  images: [
    getProjectPath("villapuncak123/3.png"),
    getProjectPath("villapuncak123/6.png"),
    getProjectPath("villapuncak123/1.png"),
    getProjectPath("villapuncak123/2.png"),
    getProjectPath("villapuncak123/4.png"),
    getProjectPath("villapuncak123/5.png"),
    getProjectPath("villapuncak123/7.png"),
  ],
} as Song;

export const DoDaily = {
  name: "DODAILY_NAME",
  artist: "DODAILY_ARTIST",
  length: "DODAILY_LENGTH",
  description: "DODAILY_DESCRIPTION",
  type: ProjectTypesEnum.MOBILE,
  imageUrl: getProjectPath("dodaily/logo.png"),
  images: [
    getProjectPath("dodaily/1.png"), 
    getProjectPath("dodaily/2.png"), 
    getProjectPath("dodaily/3.png"), 
    getProjectPath("dodaily/4.png"), 
    getProjectPath("dodaily/5.png"), 
    getProjectPath("dodaily/6.png"), 
    getProjectPath("dodaily/7.png"), 
    getProjectPath("dodaily/8.png"), 
    getProjectPath("dodaily/9.png"), 
  ],
  link: "",
  github: "https://github.com/francoborrelli/react-native-dodaily-prototype",
  skills: [tags.Flutter, tags.Firebase],
} as Song;

export const MyMenu = {
  name: "MYMENU_NAME",
  artist: "MYMENU_ARTIST",
  length: "MYMENU_LENGTH",
  description: "TENSORFLOW_DESCRIPTION",
  type: ProjectTypesEnum.MOBILE,
  imageUrl: getProjectPath("mymenu/logo.png"),
  ...
  images: [
    getProjectPath("mymenu/1.png"),
    getProjectPath("mymenu/2.png"),
    getProjectPath("mymenu/3.png"),
    getProjectPath("mymenu/4.png"),
    getProjectPath("mymenu/5.png"),
    getProjectPath("mymenu/6.png"),
    getProjectPath("mymenu/7.png"),
    getProjectPath("mymenu/8.png"),
    getProjectPath("mymenu/9.png"),
  ],
} as Song;
...
export const MasEfectivo = {
  ...
  images: [
    getProjectPath("mas_efectivo/1.png"),
    getProjectPath("mas_efectivo/2.png"),
  ],
} as Song;

...
export const tags = {
  ...
  Flutter: {
    ...
    image: 'https://cdn.prod.website-files.com/6100d0111a4ed76bc1b9fd54/62ba7b7f547a660f37c11826_flutter%201.png',
  },
  Html: {
    text: 'HTML',
    color: 'white',
  ...
  Php: {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGdAZuME1StCFun6ZRrZaqRcD2uLwArrUpaQ&s',
  },
  Tailwind: {
    text: 'Tailwind CSS',
    color: 'white',
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVaQaSogZt9WMIeJYRv4mxS2rfR8RqBnspHw&s',
  },
  VsCode: {
    text: 'Visual Studio',
    color: 'white',
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiLmCqCuBjwb9JROKKd8KvwWHzaUFp_oMMNg&s',
  },
  AndroidStudio: {
    text: 'Android Studio',
    color: 'white',
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSefMQCN963H6_TJnn_ir_Ylv1lSlYXXaw1dTD8DcYBc5iAj9pi0-IyVq-3sQlLgcwymq0&usqp=CAU',
  },
  Chrome: {
    text: 'Google Chrome',
    color: 'white',
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiNfDfEWGzO7HvJaRbQLJbJP4hfZ6T5MEUMA&s',
  },
  Mysql: {
    text: 'MySQL',
    color: 'white',

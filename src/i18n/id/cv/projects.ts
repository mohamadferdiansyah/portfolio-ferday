...
const VILLAPUNCAK123 = {
  VILLAPUNCAK123_NAME: "Villapuncak123",
  VILLAPUNCAK123_LENGTH: "2024",
  VILLAPUNCAK123_ARTIST: "Proyek pribadi",
  VILLAPUNCAK123_DESCRIPTION: `VillaPuncak123 adalah platform berbasis web yang dirancang untuk menyederhanakan proses manajemen dan pemesanan villa di daerah Puncak Bogor. Situs web ini menawarkan fitur pencarian vila berdasarkan lokasi, fasilitas, dan harga, memungkinkan pengunjung untuk melakukan reservasi online dengan mudah. Selain itu, VillaPuncak123 membantu pemilik vila mengelola data, transaksi, dan keuangan secara efisien.`,
};

const DODAILY = {
  DODAILY_NAME: "DoDaily",
  DODAILY_LENGTH: "2024",
  DODAILY_ARTIST: "Proyek pribadi",
  DODAILY_DESCRIPTION: `DoDaily adalah aplikasi daftar tugas berbasis mobile yang dirancang untuk membantu pengguna mengelola dan mengatur aktivitas harian mereka dengan efisien. Dengan fitur manajemen tugas, pengingat, dan pelacakan kemajuan, DoDaily memungkinkan pengguna untuk tetap produktif dan terorganisir dalam rutinitas mereka.`,
};

const MYMENU = {
  MYMENU_NAME: "MyMenu",
  MYMENU_ARTIST: "Proyek pribadi",
  MYMENU_LENGTH: "Masih dalam pengembangan",
  MYMENU_DESCRIPTION: `MyMenu adalah aplikasi mobile yang dirancang untuk menyederhanakan proses pemesanan bagi pelanggan restoran langsung dari meja mereka. Menampilkan tampilan menu digital, deskripsi makanan yang detail, dan opsi pemesanan yang dapat disesuaikan, MyMenu meningkatkan efisiensi layanan dan memberikan pengalaman bersantap yang modern.`,
};
...
const OBJECT_DETECTION_LOCATION_APP = {
  OBJECT_DETECTION_LOCATION_APP_NAME:
    "Herramienta de autor con posicionamiento por objetos",

...
const SMK = {
  ...
  SMK_ARTIST: 'PPLG (Rekayasa Perangkat Lunak)',
  SMK_LENGTH: '2023 - Sekarang',
  SMK_DESCRIPTION: `SMK Wikrama Bogor adalah salah satu sekolah menengah kejuruan terkemuka di Bogor, Indonesia, yang mengkhususkan diri dalam mempersiapkan siswa agar siap kerja, kompetitif, dan memiliki karakter yang baik. Didirikan dengan misi untuk menghasilkan lulusan yang kompeten, sekolah ini terkenal dengan pendidikan berkualitas tinggi, fasilitas modern, dan program pembelajaran inovatif yang berbasis teknologi.`,
};

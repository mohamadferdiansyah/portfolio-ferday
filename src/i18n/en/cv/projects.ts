...
const VILLAPUNCAK123 = {
  ...
  VILLAPUNCAK123_ARTIST: "Personal project",
  VILLAPUNCAK123_DESCRIPTION: `VillaPuncak123 is a web-based platform designed to simplify the management and booking process for villas in the Puncak Bogor area. This website offers features such as villa search based on location, amenities, and price, allowing visitors to make online reservations easily. Additionally, VillaPuncak123 helps villa owners manage data, transactions, and finances efficiently.  `,
};

const DODAILY = {
  DODAILY_NAME: "DoDaily",
  DODAILY_LENGTH: "2024",
  DODAILY_ARTIST: "Personal project",
  DODAILY_DESCRIPTION: `DoDaily is a mobile-based to-do list application designed to help users manage and organize their daily activities efficiently. With features like task management, reminders, and progress tracking, DoDaily enables users to stay productive and well-organized in their routines.`,
};

const MYMENU = {
  MYMENU_NAME: "MyMenu",
  MYMENU_ARTIST: "Personal project",
  MYMENU_LENGTH: "Still in development",
  TENSORFLOW_DESCRIPTION: `MyMenu is a mobile application designed to streamline the ordering process for restaurant customers directly from their table. Featuring a digital menu display, detailed food descriptions, and customizable order options, MyMenu enhances service efficiency and delivers a modern dining experience.`,
};

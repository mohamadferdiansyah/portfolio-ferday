...
const Vscode = {
  VISUAL_STUDIO_HELP:
    "Visual Studio Code (VSCode) is a free source-code editor made by Microsoft for Windows, Linux, and macOS. It includes support for debugging, embedded Git control, syntax highlighting, intelligent code completion, snippets, and code refactoring.",
  VISUAL_STUDIO_EXPERIENCE: `I have been using Visual Studio Code for over 3 years now. I have experience with:
    \n<b>•Extensions:</b> Utilizing a wide range of extensions to enhance productivity, such as Prettier for code formatting, ESLint for linting, and GitLens for Git integration.
    \n<b>•Customization:</b> Customizing the editor with themes, keybindings, and settings to create a personalized development environment.
    \n<b>•Integrated Terminal:</b> Using the integrated terminal to run commands and scripts without leaving the editor.
    \n<b>•Debugging:</b> Setting up and using the built-in debugger to troubleshoot and resolve issues in code.`,
  VISUAL_STUDIO_YEARS: "Expert",
};

const Androidstudio = {
  ANDROID_STUDIO_HELP:
    "Android Studio is the official integrated development environment (IDE) for Google's Android operating system, built on JetBrains' IntelliJ IDEA software and designed specifically for Android development.",
  ANDROID_STUDIO_EXPERIENCE: `I have been using Android Studio for over 3 years now. I have experience with:
    \n<b>•Project Setup:</b> Creating and configuring new Android projects, including setting up Gradle build scripts and managing dependencies.
    \n<b>•UI Design:</b> Using the built-in layout editor to design user interfaces, including working with XML layouts and the ConstraintLayout editor.
    \n<b>•Debugging:</b> Utilizing Android Studio's debugging tools to troubleshoot and resolve issues in code, including setting breakpoints, inspecting variables, and analyzing stack traces.
    \n<b>•Emulator and Device Testing:</b> Running and testing applications on the Android Emulator and physical devices to ensure compatibility and performance.
    \n<b>•Performance Profiling:</b> Using Android Studio's profiling tools to monitor and optimize application performance, including memory usage, CPU usage, and network activity.`,
  ANDROID_STUDIO_YEARS: "Beginner",
};

const Chrome = {
  GOOGLE_CHROME_HELP:
    "Google Chrome is a cross-platform web browser developed by Google. It is known for its speed, simplicity, and security.",
  GOOGLE_CHROME_EXPERIENCE:
    "I have been using Google Chrome for over 5 years now. I have experience with using Chrome Developer Tools for debugging, performance profiling, and inspecting web pages.",
  GOOGLE_CHROME_YEARS: "Intermediate",
};
...
const Php = {
  ...
  PHP_EXPERIENCE:
    "I have been using PHP for over 5 years now. I have experience with building dynamic web applications, interacting with databases, and creating custom WordPress themes and plugins.",
  PHP_YEARS: "Intermediate",
};

const Flutter = {
  FLUTTER_HELP:
    "Flutter is an open-source UI software development kit created by Google. It is used to develop applications for Android, iOS, Linux, Mac, Windows, Google Fuchsia, and the web from a single codebase.",
  FLUTTER_EXPERIENCE: `I have been using Flutter for over 2 years now. I have experience with building cross-platform mobile applications for iOS and Android using Flutter's framework and tools.`,
  FLUTTER_YEARS: "Beginner",
};
...
const Html = {
  ...
  HTML_EXPERIENCE:
    "I have been using HTML for over 7 years now. I have experience with creating semantic web pages, structuring content, and using HTML5 features.",
  HTML_YEARS: "Intermediate",
};
...
const Css = {
  ...
  CSS_EXPERIENCE:
    "I have been using CSS for over 7 years now. I have experience with styling web pages, creating responsive layouts, and using CSS preprocessors like Sass and Less.",
  CSS_YEARS: "Intermediate",
};

const Tailwind = {
  TAILWIND_CSS_HELP:
    "Tailwind CSS is a utility-first CSS framework for rapidly building custom designs.",
  TAILWIND_CSS_EXPERIENCE: `I have been using Tailwind CSS for over 1 year now. I have experience with creating custom designs, responsive layouts, and reusable components using Tailwind's utility classes.`,
  TAILWIND_CSS_YEARS: "Intermediate",
};
